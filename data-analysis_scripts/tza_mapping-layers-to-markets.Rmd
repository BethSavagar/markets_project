...
mrkta_withfeatures <- mrkta_gps %>%
  mutate(extract(pop_raster, mrkta_sf, ID = FALSE)) %>%
...
mrkta_withfeatures <- mrkta_withfeatures %>%
  mutate(extract(shp_raster_tanzania_masked, mrkta_sf, ID = FALSE)) %>%
...
mrkta_withfeatures <- mrkta_withfeatures %>%
  mutate(extract(gt_raster_tanzania_masked, mrkta_sf, ID = FALSE)) %>%
...
mrkta_withfeatures <- mrkta_withfeatures %>%
  mutate(extract(ps_raster_tanzania_masked, mrkta_sf, ID = FALSE)) %>%
  rename(ps = CLASSNAME)
