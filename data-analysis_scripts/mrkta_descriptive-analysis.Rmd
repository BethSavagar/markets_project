...
## 6) Small Ruminant Sales by Region {.tabset}
...
ggplot(sales %>% filter(species == "SR.sales.day"), aes(x=region.geomatch.final, y=sales))+
...
<!-- # translate this: -->
<!-- mrkta_info %>% select(`4.seasonal.variation.in.trade`, `4.if.yes.describe`) %>% head() %>% kable() -->
<!-- ``` -->
...
<!-- buysell_locations <- mrkta_info %>% -->
<!--   select(fid, country, district.region.code, region.geomatch.final, ward.code, ward.name, village, market.name, -->
