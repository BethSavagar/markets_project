...
# write.csv(mrktc_names_post3, file = here("data/data-cleaning_data/mrktc_names_clean3-1.csv"), row.names = F)
# write.csv(mrktc_clean3, file = here("data/data-cleaning_data/mrktc_info_clean3-1.csv"), row.names = F)
#  mrktc_clean3 <- read_csv("data/data-cleaning_data/mrktc_info_clean3-1.csv")

mrktc_gps <- mrktc_clean3 %>% 
  # left_join(mrktc_clean %>% select(fid,date,date.end,date.of.interview), by = "fid") %>%
  select(
  fid,
  date,
  date.end,
...
# write.csv(mrktc_info_raw, file = here("data/data-cleaning_data/mrktc_generalinfo_tanzania_CLEAN.csv"), row.names = F)
```
