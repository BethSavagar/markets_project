...
## Market Survey C Clean (1): check geo-link A data:

For each region, check consistency between:

  - geolinkA survey locations, date-of-survey and raw data. 
...
# 3 simiyu-bariadi-dutwa-igaganulwa-igaganulwa         2022-05-28        2022-05-14     2 ** --> Checked: Date Error (mwasamba-mwasamba)
...
## Market Survey C Clean GPS Data
