...
mrktc_activities_v5 <- mrktc_activities_v4 %>%
  ...
  mutate(
    ...
    `7.buy.homeconsumption` = if_else(grepl("home", `7.buy.reason.other.code`), 1, `7.buy.homeconsumption`),
    
    `7.buy.religious` = if_else(grepl("7", `7.buy.reason`), 1, 0), 
    `7.buy.religious` = if_else(grepl("religious", `7.buy.reason.other.code`), 1, `7.buy.religious`),
