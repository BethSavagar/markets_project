...
# Cleaning Script 1 for market A data:
- takes raw market A info survey, subset to tanzania
- Basic cleaning of string data
...
# Market A Data Cleaning:
- read in raw market A survey data
- clean location data string names
- save as "_CLEAN"
